...
def seg_and_patch(source, save_dir, patch_save_dir, mask_save_dir, stitch_save_dir, 
	...
	# pdb.set_trace()
	# slides = slides[-10:]
	slides = [slide for slide in slides if os.path.isfile(os.path.join(source, slide)) and slide.endswith('.tif')]
...
parser.add_argument('--source', type = str, default='/mnt/Xsky/zyl/dataset/CAMELYON16/training',
					help='path to folder containing raw wsi image files')
parser.add_argument('--step_size', type = int, default=768,
					help='step_size')
...
parser.add_argument('--save_dir', type = str, default='/mnt/Xsky/zyl/dataset/CAMELYON16/coords_anno_768',
