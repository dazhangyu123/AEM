...
def eval_transforms(pretrain):

	if pretrain != 'medical_ssl' and pretrain != 'natural_supervsied' and pretrain != 'UNI' and \
			pretrain != 'GigaPath' and pretrain != 'virchow':
...
class Whole_Slide_Bag_FP(Dataset):
	def __init__(self,
		...
		self.wsi = wsi
		self.roi_transforms = eval_transforms(pretrain)
